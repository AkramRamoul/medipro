...
const EmptyPrescriptionPrintable: React.FC<EmptyPrescriptionPrintableProps> = ({
    ...
    * { box-sizing: border-box; }
    ...
    .divider { ${dividerCSS} margin: 8px 0; width: 100%; opacity: 0.7; }
    ...
    const renderHeader = () => {
        switch (templateLayout) {
            ...
            case "fr-logo-left":
                return (
                    <div className="header-panel">
                        ...
                        <div className="panel-text-fr" style={{ paddingTop: "8px" }}>
                            {frContent}
                        </div>
                    </div>
                );
            case "ar-logo-right":
                return (
                    <div className="header-panel">
                        <div className="panel-text-ar" style={{ paddingRight: "15px", paddingTop: "8px" }}>
                            {arContent}
                        </div>
