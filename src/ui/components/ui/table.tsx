...
>(({ className, ...props }, ref) => (
  <tr
    ...
    className={cn(
      ...
      "even:bg-primary/[0.07] dark:even:bg-primary/[0.12]",
      "hover:bg-primary/[0.13] dark:hover:bg-primary/[0.20]",
      "hover:shadow-[inset_3px_0_0_hsl(var(--primary))]",
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 px-3 text-left align-middle text-xs font-bold uppercase tracking-widest",
