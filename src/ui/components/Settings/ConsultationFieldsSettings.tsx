    ...
    return (
        <div className="space-y-6 m-8 p-6 bg-card text-foreground border border-border rounded-lg shadow-sm text-left">
            <div className="space-y-2">
                <h3 className="text-lg font-medium">Champs personnalisés de consultation</h3>
                <p className="text-sm text-muted-foreground">
                    Ajoutez des champs supplémentaires qui apparaîtront dans le formulaire de consultation.
                </p>
            </div>
            ...
            <div className="mt-8">
                ...
                {isLoading ? (
                    ...
                    <p className="text-sm text-muted-foreground italic">Aucun champ personnalisé configuré.</p>
                ) : (
                    <div className="divide-y divide-border border rounded-md">
                        {fields.map((field) => (
                            <div key={field.id} className="flex items-center justify-between p-4 hover:bg-muted/50 transition-colors">
                                <div>
                                    <p className="font-medium">{field.label}</p>
                                    <p className="text-xs text-muted-foreground uppercase">{field.type}</p>
                                </div>
                                <Button
                                    variant="ghost"
                                    size="icon"
